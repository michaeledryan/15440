...
public class TestClient {
    ...
    /**
     * Really simple test on the ToyClass. Find one object, then print
     * something twice.
     *
    ...
    /**
     * Uses data from multiple registries/servers in the same RMI calls.
     *
     * @throws Remote440Exception
     */
    private static void test3() throws Remote440Exception {
        if (registries.length < 2) {
            System.err.println("Error: This test requires a connection to two" +
                    " registries.");
            System.exit(1);
        }
    ...
    /**
     * Both of our sample RMI classes can exist simultaneously on the
     * registry.
     *
     * @throws Remote440Exception
     */
